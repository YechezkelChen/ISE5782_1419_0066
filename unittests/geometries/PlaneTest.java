...
public class PlaneTest {
    ...
    void testFindIntersections() {
        ...
        // TC01: Test when the ray intersects the plane - this is need to be just 1 intersection point
        ...
        // TC02: Test when the ray does not intersect the plane - this is need to be 0 intersection point
        ...
        // TC11: Test when the ray is parallel to the plane and the ray included in the plane - this is need to be 0 intersection point
        ...
        // TC13: Test when Ray is orthogonal to the plane before the plane - this is need to be just 1 intersection point
        assertNull(plane2.findIntersections(new Ray(new Point(0.0, 0.0, 1.0), new Vector(0.0, 0.0, 2.0))),"There should be no point of intersection because the ray is before the plane");

        // TC14: Test when Ray is orthogonal to the plane in the plane - this is need to be 0 intersection point
        ...
        // TC15: Test when Ray is orthogonal to the plane after the plane - this is need to be 0 intersection point
        assertNull(plane2.findIntersections(new Ray(new Point(0.0, 0.0, -1.0), new Vector(0.0, 0.0, -2.0))),"There should be no point of intersection because the ray is after the plane");
        ...
        assertNull(plane2.findIntersections(new Ray(new Point(0.0, 0.0, 0.0), new Vector(0.0, 0.0, 1.0))),"There should be no point of intersection because the ray begins at the plane");
