...
public class PolygonTests {
    ...
    public void testConstructor() {
        ...
        assertThrows(IllegalArgumentException.class, //
                () -> new Polygon(new Point(0.0, 0.0, 1.0), new Point(1.0, 0.0, 0.0), new Point(0.0, 1.0, 0.0), new Point(0.0, 0.5, 0.5)),
    ...
    public void testGetNormal() {
        ...
        assertEquals(new Vector(sqrt3, sqrt3, sqrt3), pl.getNormal(new Point(0.0, 0.0, 1.0)), "Bad normal to trinagle");
    }
}
