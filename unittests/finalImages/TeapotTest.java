...
public class TeapotTest {
    private final ImageWriter imageWriter = new ImageWriter("teapotAntiAliasing", 800, 800);

    private final Camera camera = new Camera(new Point(0.0, 0.0, -1000.0), new Vector(0.0, 0.0, 1.0), new Vector(0.0, 1.0, 0.0)) //
