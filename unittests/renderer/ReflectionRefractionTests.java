...
public class ReflectionRefractionTests {
	...
	public void twoSpheres() {
		...
		scene.geometries.add( //
				new Sphere(new Point(0.0, 0.0, -50.0), 50d).setEmission(new Color(BLUE)) //
						.setMaterial(new Material().setKd(0.4).setKs(0.3).setShininess(100).setKt(new Double3(0.3))),
				new Sphere(new Point(0.0, 0.0, -50.0), 25d).setEmission(new Color(RED)) //
	...
	public void twoSpheresOnMirrors() {
		...
		scene.geometries.add( //
				new Sphere(new Point(-950.0, -900.0, -1000.0), 400d).setEmission(new Color(0, 0, 100)) //
						.setMaterial(new Material().setKd(0.25).setKs(0.25).setShininess(20).setKt(new Double3(0.5))),
				new Sphere(new Point(-950.0, -900.0, -1000.0), 200d).setEmission(new Color(100, 20, 20)) //
	...
	public void trianglesTransparentSphere() {
		Camera camera = new Camera(new Point(0.0, 0.0, 100.0), new Vector(0.0, 0.0, -1.0), new Vector(0.0, 1.0, 0.0)) //
