...
class RayTest {
     ...
     */
    void testGetPoint() {
        Ray ray = new Ray(new Point(1.0, 2.0, 3.0), new Vector(2.0, 3.0, 4.0));

        // ============ Equivalence Partitions Tests ==============
        // TC01: Test the getPoint operation with ray and t>0
        assertEquals(ray.getPoint(2), new Point(5.0, 8.0, 11.0), "getPoint of Ray with t>0 does not work correctly");

        // TC02: Test the getPoint operation with ray and t<0
        assertEquals(ray.getPoint(-2), new Point(-3.0, -4.0, -5.0), "getPoint of Ray with t<0 does not work correctly");
